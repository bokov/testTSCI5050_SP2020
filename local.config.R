...
inputdata <- c(
  dat01 = '/cloud/project/localdata/survival_pbcseq.xlsx'
 ,dat02 = '/cloud/project/localdata/survival_pbcseq.sas7bdat'
 ,dat03 = '/cloud/project/localdata/survival_pbcseq.xpt'
);
#### footer ####
c()
